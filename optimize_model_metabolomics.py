...
from cobra_utils import load_model, fetch_norm_sample_metabolomics_data
...
def optimize_model_metabolomics(
    ...
    gcms_metab_norm = fetch_norm_sample_metabolomics_data(
        model_input=model, gcms_filepath=gcms_filepath
    )
