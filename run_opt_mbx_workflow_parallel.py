...
from mmtpy_opt_workflows import optimize_model_mbx
...
def main(model_path, mbx_path, output_path):
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        # Submit the function to the pool of workers for each model file
        futures = []
